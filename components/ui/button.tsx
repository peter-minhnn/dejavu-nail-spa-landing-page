...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 focus-visible:!outline-none focus-visible:!border-0 focus-visible:!shadow-none focus:!ring-0 focus-visible:!ring-offset-0',
  {
    variants: {
      variant: {
        ...
        redShine:
          'text-primary-foreground animate-shine bg-gradient-to-r from-red-500 via-red-400 to-red-500 bg-[length:400%_100%]',
        gooeyRight:
